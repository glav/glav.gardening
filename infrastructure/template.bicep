...
param storageAccountName string = 'gardeningsadev'
param aksClusterName string = 'aksgardeningdev'
...
resource AksClusterResource 'Microsoft.ContainerService/managedClusters@2021-09-01' = {
  ...
  properties: {
    ...
    agentPoolProfiles: [
      {
        name: '${envSpecificAksClusterName}nodepool1'
        count: aksNodeCount
