...
@description('Request units per second for the container')
@minValue(400)
...
// If secondary is empty, then do not include in the array
var locations = (secondaryRegion == '') ? [
    {
...
resource accountName_resource 'Microsoft.DocumentDB/databaseAccounts@2021-01-15' = {
  ...
  properties: {
    ...
    // If enabling this, need to remove throughput setting.
    // capabilities: [
    //   {
